...
The boxes resources will be configured by Vagrantfile templates for use but you can overwrite it using your own Vagrantfile. Here is some configurations from the past to inspire
...
Why I took some decisions, issues faced and etc.
